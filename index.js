...
function MadLib (nouns,adjectives,verbs){
    ...
    this.verbs = verbs; 
    this.story = "Once upon a time [noun] there was a [noun] who [verb]. The [noun] was a [adjective] [noun] who lived under a [noun]."
...
var getWords = function (loop) {
    ...
    if (loop >= 6) {
        inquirer.prompt({
            ...
            var MadLib = new MadLib(nouns,advjectives,verbs);
            console.log(MadLib);
        })
    }
};
